...
DROPBOX_TOKEN=Gx1iJ8k2v6kAAAAAAAAAWQbplCmbs_zdjlJcSXGIaF4tSbFma4yvWqTTlTFF6zpA
...
do
  ...
  tar czf ${BACKUP_FOLDER}/${BACKUP_FILENAME} ${searchFolder}

  echo -e "Uploading to Dropbox...\n"
  curl -k --progress-bar -i --globoff -o /tmp/dropbox_${BACKUP_FILENAME} --upload-file ${BACKUP_FOLDER}/${BACKUP_FILENAME} https://api-content.dropbox.com/1/files_put/auto/${BACKUP_FILENAME}  -H "Authorization:Bearer $DROPBOX_TOKEN"
